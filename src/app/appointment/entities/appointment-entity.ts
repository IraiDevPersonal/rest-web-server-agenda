...
export class AppointmentEntity {
  ...
  static serverResponse(data: any): AppointmentModel[] {
    try {
      ...
      throw new Error(
        CustomError.getErrorMessage(
          error,
          "appointment-entity.ts: (serverResponse)"
        )
      );
    }
  }
  ...
  static upsertDTO(
    ...
    const appointment = AppointmentEntity.validateUpsertValues(object);
  ...
  private static validateUpsertValues(value: any) {
    try {
      ...
      throw new Error(
        CustomError.getErrorMessage(
          error,
          "appointment-entity.ts: (validateValues)"
        )
      );
    }
  }
